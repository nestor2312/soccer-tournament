    ...
    {{-- <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card border-0 shadow">
                <div class="card-header border-0 fondo-card TITULO">{{ __('Iniciar Sesion') }}</div>
    ...
    <div class="posicion">
        <div class="caja">
            ...
            <form method="POST" class="formulario" action="{{ route('login') }}">
                ...
                <div>
                    <input id="email" type="email" placeholder="correo" class=" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="off" autofocus>
                ...
                {{-- <input type="text" id="lname"  placeholder="Contraseña" name="lname"> --}}
